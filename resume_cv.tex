...
\geometry{left=.75in, top=.5in, right=.75in, bottom=.75in, footskip=.25in} % Configure page margins with geometry
...
\name{James}{Roeder}
\address{58 McIntosh Rd., Asheville, NC 28806}
\mobile{(216) 386-3047}

\email{jmaroeder@gmail.com}
\homepage{www.jroeder.net}
\github{jmaroeder}
\linkedin{jmaroeder}
%\skype{skypeid}
...
\position{Senior Software Engineer{\enskip\cdotp\enskip}Systems Architect} % Your expertise/fields
